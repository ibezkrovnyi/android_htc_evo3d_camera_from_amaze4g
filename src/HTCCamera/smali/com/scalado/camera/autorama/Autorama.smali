...
.method private capture()V
    ...
    const-string v0, "Autorama can not capture, already capturing. "
    ...
    const-string v0, "Start autorama capture"
...
.method private createPanoramaSession(Lcom/scalado/caps/autorama/Lens;Lcom/scalado/caps/autorama/Direction;Ljava/util/Vector;)Lcom/scalado/caps/Session;
    ...
    const-string v9, "No sources when rendering autorama."
    ...
    const-string v6, "No sources when rendering autorama."
    ...
    const-string v6, "Only one source when rendering autorama. Returning session based on this single image."
    ...
    const-string v6, "Cannot complete stitch due to Direction UNKNOWN. Returning session based on this single image."
    ...
    invoke-direct {v6, v3}, Lcom/scalado/caps/Session;-><init>(Lcom/scalado/caps/Decoder;)V
    ...
    invoke-virtual {p0, v5}, Lcom/scalado/camera/autorama/Autorama$AutoramaImage;->addToStitcher(Lcom/scalado/caps/autorama/Stitcher;)V
...
.method public getLowResolutionPanorama(Z)Lcom/scalado/caps/Session;
    ...
    const-string v4, "getLowResolutionPanorama: No last preview image found"
    ...
    const-string v4, "getLowResolutionPanorama: Direction unknown"
...
.method public stop(Z)V
    ...
    iput-boolean v4, p0, Lcom/scalado/camera/autorama/Autorama;->mStopRequested:Z

    const-string v0, "ScaladoCameraFramework"

    const-string v0, "Currently capturing. Will stop when capture completed"
    ...
    const-string v0, "Will make one more capture and then stop."
