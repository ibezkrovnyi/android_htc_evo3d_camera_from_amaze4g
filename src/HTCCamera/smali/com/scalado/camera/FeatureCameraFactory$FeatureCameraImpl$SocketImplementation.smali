...
.method private setInternalCallback()V
    ...
    const-string v7, "assign preview buffer H:"
    ...
    invoke-direct {v6}, Lcom/scalado/base/Size;-><init>()V

    iput-object v6, p0, Lcom/scalado/camera/FeatureCameraFactory$FeatureCameraImpl$SocketImplementation;->mPreviewImageSize:Lcom/scalado/base/Size;
    ...
    invoke-static {v6}, Lcom/scalado/camera/utils/Translators;->translateToScaladoImageConfig(I)Lcom/scalado/base/Image$Config;

    move-result-object v1

    iget-object v6, p0, Lcom/scalado/camera/FeatureCameraFactory$FeatureCameraImpl$SocketImplementation;->mPreviewImageSize:Lcom/scalado/base/Size;

    invoke-virtual {v6, v2}, Lcom/scalado/base/Size;->setHeight(I)V

    iget-object v6, p0, Lcom/scalado/camera/FeatureCameraFactory$FeatureCameraImpl$SocketImplementation;->mPreviewImageSize:Lcom/scalado/base/Size;

    invoke-virtual {v6, v3}, Lcom/scalado/base/Size;->setWidth(I)V
    ...
    invoke-direct {v6, v7, v1}, Lcom/scalado/base/Image;-><init>(Lcom/scalado/base/Size;Lcom/scalado/base/Image$Config;)V

    iput-object v6, p0, Lcom/scalado/camera/FeatureCameraFactory$FeatureCameraImpl$SocketImplementation;->mPreviewImage:Lcom/scalado/base/Image;
    ...
    iput-boolean v9, p0, Lcom/scalado/camera/FeatureCameraFactory$FeatureCameraImpl$SocketImplementation;->isReceivingCallbacks:Z
...
.method public doSetParameters(Lcom/scalado/camera/Camera$Parameters;)V
    ...
    const-string v2, "Failed changing camera parameters: "
