...
.method public createDecoder(Lcom/scalado/stream/Stream;)Lcom/scalado/base/Iterator;
    ...
    :cond_0
    iget-object v2, p0, Lcom/scalado/caps/codec/decoder/DecoderFactory;->providers:Ljava/util/AbstractList;
    ...
    check-cast v0, Lcom/scalado/caps/codec/decoder/DecoderProvider;

    invoke-virtual {v0, v1}, Lcom/scalado/caps/codec/decoder/DecoderProvider;->checkImageType(I)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v0, p1}, Lcom/scalado/caps/codec/decoder/DecoderProvider;->create(Lcom/scalado/stream/Stream;)Lcom/scalado/base/Iterator;
