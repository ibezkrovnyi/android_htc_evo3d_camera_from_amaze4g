...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/MenuHandler;->mGpuEffectContr:Lcom/android/camera/GpuEffectController;
...
.method static synthetic access$100(Lcom/android/camera/MenuHandler;)Landroid/view/View;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/camera/MenuHandler;)Landroid/widget/TextView;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/camera/MenuHandler;)Z
    .locals 1
...
.method static synthetic access$1400(Lcom/android/camera/MenuHandler;I)Z
    .locals 1
...
.method static synthetic access$1500(Lcom/android/camera/MenuHandler;)Landroid/widget/ListView;
    .locals 1
...
.method static synthetic access$1700(Lcom/android/camera/MenuHandler;)I
    .locals 1
...
.method static synthetic access$1800(Lcom/android/camera/MenuHandler;I)Z
    .locals 1
...
.method static synthetic access$1900(Lcom/android/camera/MenuHandler;)[Ljava/lang/String;
    .locals 1
...
.method static synthetic access$200(Lcom/android/camera/MenuHandler;)Lcom/android/camera/OnScreenPreference;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/camera/MenuHandler;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$2100(Lcom/android/camera/MenuHandler;)Lcom/android/camera/widget/SettingsView;
    .locals 1
...
.method static synthetic access$2200(Lcom/android/camera/MenuHandler;Landroid/view/View;ILandroid/view/ViewGroup;Z)Landroid/view/View;
    .locals 1
...
.method static synthetic access$2300(Lcom/android/camera/MenuHandler;Landroid/view/View;Z)V
    .locals 0
...
.method static synthetic access$300(Lcom/android/camera/MenuHandler;)Lcom/android/camera/HTCCamera;
    .locals 1
...
.method static synthetic access$400(Lcom/android/camera/MenuHandler;)Landroid/os/Handler;
    .locals 1
...
.method private checkAutoCaptureItem(I)Z
    ...
    iget v1, p0, Lcom/android/camera/MenuHandler;->mFaceIndex:I

    if-eq p1, v1, :cond_0

    iget v1, p0, Lcom/android/camera/MenuHandler;->mTimerIndex:I
    ...
    invoke-virtual {v1, p1, v5}, Landroid/widget/ListView;->setItemChecked(IZ)V
    ...
    iget v1, p0, Lcom/android/camera/MenuHandler;->mTimerItems:I
    ...
    iget v2, p0, Lcom/android/camera/MenuHandler;->mTimerItems:I
    ...
    iget-object v1, p0, Lcom/android/camera/MenuHandler;->mUIHandler:Landroid/os/Handler;

    invoke-static {v1, v4}, Lcom/android/camera/MessageHandler;->removeMessages(Landroid/os/Handler;I)V

    iget-object v1, p0, Lcom/android/camera/MenuHandler;->mUIHandler:Landroid/os/Handler;

    invoke-static {v1, v4, v7, v3, v6}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
    ...
    invoke-static {v1, v4, v0, v3, v6}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
...
.method private createAutoCaptureList()Landroid/view/View;
    ...
    new-instance v0, Lcom/android/camera/MenuHandler$11;

    invoke-direct {v0, p0}, Lcom/android/camera/MenuHandler$11;-><init>(Lcom/android/camera/MenuHandler;)V
...
.method private createImagePropertyView()Landroid/view/View;
    ...
    new-instance v2, Lcom/android/camera/MenuHandler$10;

    invoke-direct {v2, p0}, Lcom/android/camera/MenuHandler$10;-><init>(Lcom/android/camera/MenuHandler;)V
...
.method private createSettingsView()V
    ...
    invoke-virtual {v2}, Lcom/android/camera/OnScreenPreference;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-object v1, p0, Lcom/android/camera/MenuHandler;->mSubMenuListener:Lcom/android/camera/widget/SettingsView$OnSubMenuOpenedListener;

    invoke-virtual {v0, v1}, Lcom/android/camera/widget/SettingsView;->setOnSubMenuOpenedListenerListener(Lcom/android/camera/widget/SettingsView$OnSubMenuOpenedListener;)V
    ...
    iget-object v0, p0, Lcom/android/camera/MenuHandler;->mLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v1}, Lcom/android/camera/OnScreenPreference;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method private getAutoCaptureString()Ljava/lang/String;
    ...
    const-string v13, "no-value"

    const-string v12, "MenuHandler"

    const-string v10, "MenuHandler"

    const-string v10, "Get Auto-capture String"

    invoke-static {v12, v10}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, "Get PreferenceName.PREF_FACE_NUMBER = "
    ...
    const-string v11, "Get PreferenceName.PREF_SELF_TIMER = "
...
.method private getListViewWidth(I)I
    ...
    :cond_1
    iget v0, p0, Lcom/android/camera/MenuHandler;->mListWidth:I
...
.method private setEnabledStateOnViews(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, v3, p2}, Lcom/android/camera/MenuHandler;->setEnabledStateOnViews(Landroid/view/View;Z)V
...
# virtual methods
.method public checkMenuSetting()V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/OnScreenPreference;->checkSceneSettingForDOT(Z)Z
...
.method public getCustomView(Landroid/preference/Preference;)Landroid/view/View;
    ...
    :cond_1
    const-string v1, "pref_camera_auto_capture"
...
.method public getMenuResolutionItem(I)Ljava/lang/String;
    ...
    check-cast p0, Lcom/android/camera/ResolutionMenuItem;

    iget-object v1, p0, Lcom/android/camera/ResolutionMenuItem;->resolution:Lcom/android/camera/Resolution;
...
.method public initMenuHandler(Lcom/android/camera/HTCCamera;Lcom/android/camera/CameraThread;Landroid/view/View;Lcom/android/camera/GpuEffectController;)V
    .locals 5

    const-string v4, "MenuHandler"
    ...
    iget-object v1, p0, Lcom/android/camera/MenuHandler;->mCameraThread:Lcom/android/camera/CameraThread;
    ...
    iput-object p4, p0, Lcom/android/camera/MenuHandler;->mGpuEffectContr:Lcom/android/camera/GpuEffectController;

    new-instance v1, Lcom/android/camera/OnScreenPreference;

    invoke-direct {v1}, Lcom/android/camera/OnScreenPreference;-><init>()V
    ...
    iget-object v3, p0, Lcom/android/camera/MenuHandler;->mCameraThread:Lcom/android/camera/CameraThread;

    invoke-virtual {v1, v2, v3, p0}, Lcom/android/camera/OnScreenPreference;->initOnScreenPreference(Lcom/android/camera/HTCCamera;Lcom/android/camera/CameraThread;Lcom/android/camera/MenuHandler;)V
    ...
    check-cast v1, Lcom/android/camera/widget/SlidingDrawer;
    ...
    iput v1, p0, Lcom/android/camera/MenuHandler;->mListWidth:I
    ...
    new-instance v1, Lcom/android/camera/MenuHandler$1;

    invoke-direct {v1, p0}, Lcom/android/camera/MenuHandler$1;-><init>(Lcom/android/camera/MenuHandler;)V
    ...
    new-instance v0, Lcom/android/camera/MenuHandler$2;

    invoke-direct {v0, p0}, Lcom/android/camera/MenuHandler$2;-><init>(Lcom/android/camera/MenuHandler;)V
...
.method public releaseMenuHandler()V
    ...
    iput-object v1, p0, Lcom/android/camera/MenuHandler;->mGpuEffectContr:Lcom/android/camera/GpuEffectController;
...
.method public updateDisableItems()V
    ...
    iget-object v3, p0, Lcom/android/camera/MenuHandler;->mGpuEffectContr:Lcom/android/camera/GpuEffectController;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/android/camera/MenuHandler;->mGpuEffectContr:Lcom/android/camera/GpuEffectController;

    invoke-virtual {v3}, Lcom/android/camera/GpuEffectController;->getCurrEffect()Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lcom/android/camera/OnScreenPreference;->enableImageProperty(Z)Z
    ...
    invoke-virtual {v3, v0}, Lcom/android/camera/OnScreenPreference;->enableSceneOptions(Z)Z
    ...
    invoke-virtual {v3, v1}, Lcom/android/camera/OnScreenPreference;->enableISO(Z)Z
    ...
    invoke-virtual {v3, v6}, Lcom/android/camera/OnScreenPreference;->updateFaceDetection(Z)Z
...
.method public updateOrientation(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/camera/MenuHandler;->getListViewWidth(I)I

    move-result v0

    invoke-direct {p0, v0}, Lcom/android/camera/MenuHandler;->updateListViewWidth(I)V

    invoke-direct {p0, p1}, Lcom/android/camera/MenuHandler;->updateImagePropertyView(I)V
