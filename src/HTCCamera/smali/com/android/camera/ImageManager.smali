...
.method public static hasStorage(ZLjava/lang/String;)Z
    ...
    sput-boolean v4, Lcom/android/camera/ImageManager;->mIsNonWritable:Z
    ...
    sput-boolean v5, Lcom/android/camera/ImageManager;->mIsNonWritable:Z

    const-string v2, "ImageManager"

    const-string v2, "writable is false"
...
.method public static setVideoSize(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    const-string v0, "catch - setVideoSize with exception: "

    invoke-static {v12, v0, v8}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public addImage(Landroid/content/Context;Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;JLandroid/location/Location;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-interface {v9, v3, v11}, Landroid/database/Cursor;->updateString(ILjava/lang/String;)Z
    ...
    const-string v5, "addImage() - Cursor = null"
    ...
    const-string v5, "addImage() - uri = null"
...
.method public addNecessaryExifToFile(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    const-string v4, "addNecessaryExifToFile:   filePathis null"
    ...
    const-string v5, "unable to  add necessary exifto  "
    ...
    const-string v5, "saveImageContents make: "
    ...
    const-string v5, "saveImageContents model: "
    ...
    const-string v5, "saveImageContents originaldate: "
    ...
    invoke-direct {v14, v15}, Landroid/media/ExifInterface;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v14, v4, v11}, Landroid/media/ExifInterface;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
...
.method public addVideo(Landroid/content/Context;Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;JLandroid/location/Location;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Landroid/net/Uri;
    ...
    const-string v11, "addImage id is "
    ...
    :cond_1
    sget-object v9, Lcom/android/camera/ImageManager;->sStorageURI_Video:Landroid/net/Uri;
...
.method public allImages(Landroid/content/Context;Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$DataLocation;IILjava/lang/String;Landroid/net/Uri;)Lcom/android/camera/ImageManager$IImageList;
    ...
    const-string v6, "initializing ... haveSdCard == "
    ...
    sget-object v8, Lcom/android/camera/ImageManager;->sStorageURI_Video:Landroid/net/Uri;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/camera/ImageManager$VideoList;-><init>(Lcom/android/camera/ImageManager;Landroid/content/Context;Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V
...
.method public storeImage(Landroid/net/Uri;Landroid/content/Context;Landroid/content/ContentResolver;ILandroid/graphics/Bitmap;[B)Lcom/android/camera/ImageManager$IAddImage_cancelable;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/camera/ImageManager$1AddImageCancelable;-><init>(Lcom/android/camera/ImageManager;Landroid/graphics/Bitmap;[BLandroid/net/Uri;Landroid/content/ContentResolver;Landroid/content/Context;I)V
