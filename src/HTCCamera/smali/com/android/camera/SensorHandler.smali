...
.method private checkHandShake([F)V
    ...
    const-string v6, "SensorValue.RotateChanged"
    ...
    invoke-direct {v3, v6, v0}, Lcom/android/camera/BooleanEvent;-><init>(Ljava/lang/String;Z)V
...
.method private checkifChange([F)Z
    ...
    sget v2, Lcom/android/camera/SensorHandler;->STABLE_THRESHOLD:F
    ...
    sget v2, Lcom/android/camera/SensorHandler;->UNSTABLE_THRESHOLD:F
    ...
    invoke-virtual {p0, v3}, Lcom/android/camera/SensorHandler;->setTouchThreshold(Z)V
...
.method private releaseFileObserver()V
    ...
    const-string v1, "releaseFileObserver() - start"
    ...
    const-string v1, "releaseFileObserver() - end"
...
.method private setupFileObserver()V
    ...
    const-string v1, "setupFileObserver() - start"
    ...
    const-string v1, "setupFileObserver() - end"
    ...
    const-string v1, "mFileObserver.startWatching() failed!!"
...
.method public registerSensor()V
    ...
    const-string v7, "SensorHandler"

    const-string v5, "SensorHandler"

    const-string v5, "registerSensor() - start"

    invoke-static {v7, v5}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "registerSensor() - end, mIsRegistered = true"
    ...
    const-string v5, "registerSensor() - end"
...
.method public unregisterSensor()V
    ...
    const-string v6, "SensorHandler"

    const-string v4, "SensorHandler"

    const-string v4, "unregisterSensor() - start"
    ...
    const-string v4, "unregisterSensor() - end, mIsRegistered = false"
    ...
    const-string v5, "Support sensor: "
    ...
    const-string v4, "unregisterSensor() - end"
