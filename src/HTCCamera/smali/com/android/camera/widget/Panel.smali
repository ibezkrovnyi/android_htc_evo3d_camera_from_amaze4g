...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v5, p0, Lcom/android/camera/widget/Panel;->setting_bar_is_right:Z

    iput v5, p0, Lcom/android/camera/widget/Panel;->open_duration:I

    iput v5, p0, Lcom/android/camera/widget/Panel;->close_duration:I

    new-instance v2, Lcom/android/camera/widget/Panel$1;

    invoke-direct {v2, p0}, Lcom/android/camera/widget/Panel$1;-><init>(Lcom/android/camera/widget/Panel;)V

    iput-object v2, p0, Lcom/android/camera/widget/Panel;->touchListener:Landroid/view/View$OnTouchListener;

    new-instance v2, Lcom/android/camera/widget/Panel$2;

    invoke-direct {v2, p0}, Lcom/android/camera/widget/Panel$2;-><init>(Lcom/android/camera/widget/Panel;)V

    iput-object v2, p0, Lcom/android/camera/widget/Panel;->clickListener:Landroid/view/View$OnClickListener;

    new-instance v2, Lcom/android/camera/widget/Panel$3;

    invoke-direct {v2, p0}, Lcom/android/camera/widget/Panel$3;-><init>(Lcom/android/camera/widget/Panel;)V

    iput-object v2, p0, Lcom/android/camera/widget/Panel;->startAnimation:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/camera/widget/Panel$4;

    invoke-direct {v2, p0}, Lcom/android/camera/widget/Panel$4;-><init>(Lcom/android/camera/widget/Panel;)V

    iput-object v2, p0, Lcom/android/camera/widget/Panel;->animationListener:Landroid/view/animation/Animation$AnimationListener;

    sget-object v2, Lcom/android/camera/R$styleable;->Panel:[I
    ...
    iput v2, p0, Lcom/android/camera/widget/Panel;->mDuration:I

    invoke-virtual {v0, v6, v6}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result v2

    iput v2, p0, Lcom/android/camera/widget/Panel;->mPosition:I
    ...
    iput-boolean v2, p0, Lcom/android/camera/widget/Panel;->mLinearFlying:Z
    ...
    iput v2, p0, Lcom/android/camera/widget/Panel;->mWeight:F
    ...
    iput v2, p0, Lcom/android/camera/widget/Panel;->mHandleId:I
    ...
    iput v2, p0, Lcom/android/camera/widget/Panel;->mContentId:I
    ...
    iget-object v3, p0, Lcom/android/camera/widget/Panel;->mGestureListener:Lcom/android/camera/widget/Panel$PanelOnGestureListener;
    ...
    invoke-virtual {p0, v5}, Lcom/android/camera/widget/Panel;->setBaselineAligned(Z)V
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Lcom/android/camera/widget/Panel;->mContentHeight:I
    ...
    :cond_5
    iget v1, p0, Lcom/android/camera/widget/Panel;->mContentWidth:I
...
.method protected onFinishInflate()V
    ...
    const-string v7, "Your Panel must have a child View whose id attribute is \'R.id."
