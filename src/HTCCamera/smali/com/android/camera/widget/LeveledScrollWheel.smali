...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v4, p0, v0, v8}, Landroid/view/FocusFinder;->findNextFocus(Landroid/view/ViewGroup;Landroid/view/View;I)Landroid/view/View;
    ...
    :pswitch_0
    iget v4, p0, Lcom/android/camera/widget/LeveledScrollWheel;->mCurLevel:I

    mul-int/lit8 v5, v3, 0x1

    sub-int/2addr v4, v5

    invoke-virtual {p0, v4, v6, v7}, Lcom/android/camera/widget/LeveledScrollWheel;->scrollToLevel(IZI)Z
...
.method public scrollToLevel(IZI)Z
    ...
    const-string v3, "LeveledScrollWheel"
    ...
    const-string v1, "levels not set, return ;"
    ...
    const-string v1, "levelNum out of bound, return "
...
.method public setCurrentLevel(I)Z
    ...
    const-string v2, "LeveledScrollWheel"

    iget-object v0, p0, Lcom/android/camera/widget/LeveledScrollWheel;->mLevelsInLength:[I

    if-nez v0, :cond_0

    const-string v0, "LeveledScrollWheel"

    const-string v0, "mLevelsInLength not set, return ;"
    ...
    iget v0, p0, Lcom/android/camera/widget/LeveledScrollWheel;->mLevelNum:I
    ...
    const-string v0, "levelNum out of bound, return "
