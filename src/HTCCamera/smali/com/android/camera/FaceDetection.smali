...
.method private calculateFocusFace([Lcom/android/camera/FaceDetection$Face;S)S
    ...
    iget-object v8, v13, Lcom/android/camera/FaceDetection$Face;->range:Landroid/graphics/Rect;
...
.method private getFaces([Lcom/android/camera/FaceDetection$Face;)S
    ...
    iget-object v11, p0, Lcom/android/camera/FaceDetection;->mCameraThread:Lcom/android/camera/CameraThread;

    if-nez v11, :cond_0

    const-string v11, "FaceDetection"

    const-string v12, "getFaces() failed - mCameraThread == null"
    ...
    const-string v12, "getFaces() failed - device == null"
    ...
    iget-object v11, p0, Lcom/android/camera/FaceDetection;->mHTCCamera:Lcom/android/camera/HTCCamera;
    ...
    invoke-virtual {v11, v12}, Lcom/android/camera/HTCCamera;->updateFaceIcon(I)V
    ...
    :cond_4
    const-string v11, "ola-fd-rect"

    invoke-virtual {v7, v11}, Landroid/hardware/Camera$Parameters;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lcom/android/camera/HTCCamera;->getEventManager()Lcom/android/camera/EventManager;

    move-result-object v11

    new-instance v12, Lcom/android/camera/BooleanEvent;

    const-string v13, "PortraitMode.Changed"

    invoke-direct {v12, v13, v3}, Lcom/android/camera/BooleanEvent;-><init>(Ljava/lang/String;Z)V

    invoke-virtual {v11, v12}, Lcom/android/camera/EventManager;->raiseEvent(Lcom/android/camera/Event;)V
    ...
    const-string v13, "numFaces > MAX_FACE_NUM: "
    ...
    iget-object v11, v11, Lcom/android/camera/FaceDetection$Face;->range:Landroid/graphics/Rect;
    ...
    iget v11, p0, Lcom/android/camera/FaceDetection;->mPortraitThreshold:I
    ...
    invoke-direct {v12, v13, v14}, Lcom/android/camera/BooleanEvent;-><init>(Ljava/lang/String;Z)V
    ...
    const-string v13, "getFace failed: "
...
.method private insideCentralArea(Landroid/graphics/Rect;)Z
    ...
    iget-object v6, p0, Lcom/android/camera/FaceDetection;->mHTCCamera:Lcom/android/camera/HTCCamera;

    invoke-virtual {v6}, Lcom/android/camera/HTCCamera;->hasPreviewFilterLayout()Z
...
.method private insideCentralAreaMix([Lcom/android/camera/FaceDetection$Face;I)Z
    ...
    iget-object v8, p0, Lcom/android/camera/FaceDetection;->mHTCCamera:Lcom/android/camera/HTCCamera;

    invoke-virtual {v8}, Lcom/android/camera/HTCCamera;->hasPreviewFilterLayout()Z
...
.method private satisfyAutoCapture()Z
    ...
    iget-object v0, p0, Lcom/android/camera/FaceDetection;->mCameraThread:Lcom/android/camera/CameraThread;
...
.method public clearFocusFace()V
    ...
    const-string v1, "%01d%02d%02d%03d%03d%03d%01d%03d%3d"
...
.method public getFocusFace()Lcom/android/camera/FaceDetection$Face;
    ...
    const-string v0, "getFocusFace()"

    invoke-static {v2, v0}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/camera/FaceDetection;->mFace:[Lcom/android/camera/FaceDetection$Face;

    invoke-direct {p0, v0}, Lcom/android/camera/FaceDetection;->getFaces([Lcom/android/camera/FaceDetection$Face;)S

    move-result v0

    iput-short v0, p0, Lcom/android/camera/FaceDetection;->mFaceNum:S

    iget-short v0, p0, Lcom/android/camera/FaceDetection;->mFaceNum:S
    ...
    const-string v0, "getFocusFace() - mFaceNum < 1"
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/camera/FaceDetection;->calculateFocusFace([Lcom/android/camera/FaceDetection$Face;S)S
    ...
    const-string v1, "getFocusFace() - focus: "
    ...
    iget-short v0, p0, Lcom/android/camera/FaceDetection;->mFocusIndex:S

    if-gez v0, :cond_1

    const-string v0, "FaceDetection"

    const-string v0, "getFocusFace() - mFocusIndex < 0"
...
.method public quickFocus()Z
    ...
    const-string v0, "quickFocus() failed - bStartDetection == false"
...
.method public setFocusFace()V
    ...
    const-string v9, "setFocusFace(): "

    const-string v8, "FaceDetection"
    ...
    invoke-static {v8, v1}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v7}, Lcom/android/camera/MessageHandler;->removeMessages(Landroid/os/Handler;I)V

    iget-object v1, p0, Lcom/android/camera/FaceDetection;->mCameraHandler:Landroid/os/Handler;

    invoke-static {v1, v7, v6, v6, v0}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
...
.method public startCheckLoop()V
    ...
    const-string v0, "startCheckLoop()"
    ...
    const-string v0, "startCheckLoop() failed - mUIHandler == null"
    ...
    const-string v0, "startCheckLoop() failed - bStartDetection == false"
...
.method public startFaceDetection()V
    ...
    const-string v1, "startFaceDetection() failed - mCamController == null"
    ...
    const-string v1, "%01d%02d%02d%03d%03d%03d%01d%3d%3d"
    ...
    invoke-static {v1, v7, v5, v5, v0}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
...
.method public stopCheckLoop()V
    ...
    const-string v0, "stopCheckLoop() failed - mUIHandler == null"
    ...
    const-string v0, "stopCheckLoop() failed - bStartDetection == false"
...
.method public stopFaceDetection()V
    ...
    const-string v1, "stopFaceDetection() failed - mCamController == null"
    ...
    iput-boolean v5, p0, Lcom/android/camera/FaceDetection;->bStartDetection:Z
    ...
    const-string v1, "%01d%02d%02d%03d%03d%03d%01d%03d%03d"
