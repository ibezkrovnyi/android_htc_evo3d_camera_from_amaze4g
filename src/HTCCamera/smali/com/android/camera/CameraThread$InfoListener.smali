...
.method public onInfo(Landroid/media/MediaRecorder;II)V
    ...
    const-string v2, "*********** MEDIA_RECORDER_INFO_MAX_DURATION_REACHED"

    invoke-static {v5, v2}, Lcom/android/camera/LOG;->W(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "mRecording = false, do nothing"
    ...
    const-string v2, "mRecordLimitCheck = null, do nothing"
    ...
    const-string v2, "InfoListener, should not enter this state !!!!!!!!!!!!!!!!"

    invoke-static {v5, v2}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "InfoListener, reach file size limit - do nothing"
    ...
    const-string v2, "Block Capture UI - InfoListener, reach time limit to stop recorder"
    ...
    invoke-virtual {v2, v7}, Lcom/android/camera/HTCCamera;->setBlockCaptureUI(Z)V
    ...
    invoke-static {v2, v9, v6, v6, v8}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
    ...
    const-string v2, "InfoListener, api reach time limit - wait ui reach time limit"
    ...
    const-string v2, "*********** MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED"
    ...
    const-string v2, "InfoListener, reach FATA32 file \'system file size limitation"
    ...
    const-string v2, "Block Capture UI - InfoListener, reach max file size to stop recorder"
    ...
    const-string v2, "InfoListener, ui reach time limit, no api - do nothing"
    ...
    :cond_8
    invoke-virtual {v0, v7}, Lcom/android/camera/RecordLimitCheck;->setFileSizelimit_API(Z)V
    ...
    const-string v2, "InfoListener, api reach time limit, do nothing"
