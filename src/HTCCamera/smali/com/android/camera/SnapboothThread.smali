...
.method private cancelCapture()V
    ...
    const-string v0, "cancelCapture - start"
    ...
    const-string v0, "cancelCapture - end"
...
.method private capture()Z
    ...
    const-string v9, "SnapboothThread"

    const-string v4, "SnapboothThread"

    const-string v4, "start to capture photo"
    ...
    invoke-virtual {v4}, Lcom/android/camera/HTCSnapbooth;->isServiceMode()Z
    ...
    iput-boolean v10, p0, Lcom/android/camera/SnapboothThread;->mIsCapturing:Z

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    iget v5, p0, Lcom/android/camera/SnapboothThread;->mJPEGQuality:I

    invoke-virtual {v4, v5}, Lcom/android/camera/CameraController;->setJpegQuality(I)V
    ...
    invoke-static {v4, v8}, Lcom/android/camera/rotate/OrientationConfig;->mapDrgreeToUIOrientationEx(IZ)I
    ...
    invoke-static {v9, v4}, Lcom/android/camera/LOG;->W(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    invoke-virtual {v4, v0}, Lcom/android/camera/CameraController;->setRotation(I)V
    ...
    invoke-virtual {v4, v2}, Lcom/android/camera/CameraController;->setLocation(Landroid/location/Location;)V

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    const-string v5, "img-timestamp"

    const-string v6, "0"

    invoke-virtual {v4, v5, v6}, Lcom/android/camera/CameraController;->setCameraParameter(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "Camera - takePicture"

    invoke-static {v9, v4}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v4, Lcom/android/camera/TIME;->ReadyTakePicture:Lcom/android/camera/TIME$Value;

    invoke-virtual {v4}, Lcom/android/camera/TIME$Value;->End()V

    sget-object v4, Lcom/android/camera/TIME;->ShutterCallback:Lcom/android/camera/TIME$Value;

    invoke-virtual {v4}, Lcom/android/camera/TIME$Value;->Start()V
    ...
    iget-object v5, p0, Lcom/android/camera/SnapboothThread;->mShutterCallback:Landroid/hardware/Camera$ShutterCallback;

    iget-object v6, p0, Lcom/android/camera/SnapboothThread;->mRawPictureCallback:Landroid/hardware/Camera$PictureCallback;

    iget-object v7, p0, Lcom/android/camera/SnapboothThread;->mJpegPictureCallback:Landroid/hardware/Camera$PictureCallback;

    invoke-virtual {v4, v5, v6, v7}, Landroid/hardware/Camera;->takePicture(Landroid/hardware/Camera$ShutterCallback;Landroid/hardware/Camera$PictureCallback;Landroid/hardware/Camera$PictureCallback;)V
    :try_end_0
    ...
    iput-boolean v8, p0, Lcom/android/camera/SnapboothThread;->mIsTakingPicture:Z
    ...
    const-string v4, "take picture exception - mCaptureState = CAPTURE_STATE_ERROR"

    invoke-static {v9, v4}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V

    const-string v4, "SnapboothThread"

    const-string v4, "take picture exception. Camera app finished"

    invoke-static {v9, v4, v1}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private loadResolution()V
    ...
    const-string v0, "loadResolution() - start"
    ...
    const-string v0, "loadResolution() - end"
...
.method closeCamera()V
    ...
    const-string v2, "SnapboothThread"
    ...
    const-string v0, "before stopPreview"
    ...
    const-string v0, "after stopPreview"
    ...
    const-string v0, "before release"
    ...
    const-string v0, "close camera - mCaptureState = CAPTURE_STATE_IDLE"
    ...
    const-string v0, "Release Camera - set mIsLastCameraClosed to true"
    ...
    const-string v0, "mCameraDevice == null in closeCamera"
...
.method public startPreview(IZ)V
    ...
    const-string v4, "startPreview() - start"
    ...
    const-string v5, "Camera has been in Prevewing. mPreviewing="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/camera/SnapboothThread;->mPreviewing:Z
    ...
    invoke-static {v7, v4}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "Open camera while startPreview"
    ...
    iget-object v5, p0, Lcom/android/camera/SnapboothThread;->mErrorCallback:Landroid/hardware/Camera$ErrorCallback;
    ...
    const-string v5, "StartPreview - Set mIsLastCameraClosed to false"
    ...
    invoke-direct {v4, v5}, Lcom/android/camera/CameraController;-><init>(Landroid/hardware/Camera;)V
    ...
    invoke-static {v4, v5}, Lcom/android/camera/HTCCameraAdvanceSetting;->initPrefrenceFiles(Landroid/app/Activity;Lcom/android/camera/CameraController;)Z

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    const-string v5, "touch-aec"
    ...
    const-string v4, "Disable touch aec !!!"
    ...
    const-string v4, "Start preview - disable continue AF !!!"

    invoke-static {v7, v4}, Lcom/android/camera/LOG;->W(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    const-string v5, "cam-mode"

    invoke-virtual {v4, v5, v8}, Lcom/android/camera/CameraController;->setCameraParameter(Ljava/lang/String;I)V

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mCamController:Lcom/android/camera/CameraController;

    const-string v5, "front-camera-mode"
    ...
    iget v5, p0, Lcom/android/camera/SnapboothThread;->Camera_Mode_Width:I

    iget v6, p0, Lcom/android/camera/SnapboothThread;->Camera_Mode_Height:I

    invoke-virtual {v4, v5, v6}, Lcom/android/camera/CameraController;->setPictureSizeParameter(II)V
    ...
    const-string v5, "SetPictureSize: CAMERA MODE, Width = "
    ...
    iget v5, p0, Lcom/android/camera/SnapboothThread;->Camera_Mode_Height:I
    ...
    iget v5, p0, Lcom/android/camera/SnapboothThread;->Camera_Preview_Width:I

    iget v6, p0, Lcom/android/camera/SnapboothThread;->Camera_Preview_Height:I

    invoke-virtual {v4, v5, v6}, Lcom/android/camera/CameraController;->setPreviewSizeParameter(II)V
    ...
    const-string v5, "SetPreviewSize: CAMERA MODE, Width = "
    ...
    iget v5, p0, Lcom/android/camera/SnapboothThread;->Camera_Preview_Height:I
    ...
    const-string v5, "taking-picture-zoom"

    invoke-virtual {v4, v5}, Lcom/android/camera/CameraController;->getSettingsInfo(Ljava/lang/String;)Lcom/android/camera/CameraController$SettingInfo;
    ...
    sput-boolean v8, Lcom/android/camera/HTCCameraAdvanceSetting;->mIsInitZoom:Z
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/camera/CameraController;->setCameraParameter(Ljava/lang/String;I)V
    ...
    new-instance v5, Lcom/android/camera/SnapboothThread$6;

    invoke-direct {v5, p0}, Lcom/android/camera/SnapboothThread$6;-><init>(Lcom/android/camera/SnapboothThread;)V
    ...
    :goto_2
    iput-boolean v9, p0, Lcom/android/camera/SnapboothThread;->mPreviewing:Z

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mSnapboothHandler:Lcom/android/camera/SnapboothThread$MainHandler;

    invoke-virtual {v4, v10}, Lcom/android/camera/SnapboothThread$MainHandler;->hasMessages(I)Z

    move-result v4

    if-nez v4, :cond_4

    iget-object v4, p0, Lcom/android/camera/SnapboothThread;->mUIHandler:Landroid/os/Handler;
    ...
    invoke-static {v4, v10, v5, v8, v6}, Lcom/android/camera/MessageHandler;->sendObtainMessage(Landroid/os/Handler;IIILjava/lang/Object;)V
    ...
    const-string v4, "start_preview() - end"
    ...
    const-string v4, "mCameraDevice.setPreviewDisplay failed"

    invoke-static {v7, v4, v1}, Lcom/android/camera/LOG;->E(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
