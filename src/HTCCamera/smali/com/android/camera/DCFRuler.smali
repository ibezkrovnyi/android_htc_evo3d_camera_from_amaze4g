...
.method public static backToCounterForVideo(Landroid/app/Activity;)V
    ...
    invoke-static {p0, v4, v3}, Lcom/android/camera/HTCCameraAdvanceSetting;->writePreference(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/Object;)Z
...
.method public static backupDcimDirectory(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    const-string v6, "DCFRuler"

    const-string v3, "DCIM"

    invoke-static {p1, v7}, Lcom/android/camera/FileUtility;->backupDirectory(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v3, "Cannot create new \'DCIM\' directory."
...
.method public static declared-synchronized generateObjectsMap(Ljava/lang/String;)Ljava/util/TreeMap;
    ...
    const-class v9, Lcom/android/camera/DCFRuler;
    ...
    invoke-static {v10}, Lcom/android/camera/DCFRuler;->checkDCFFormat(Ljava/io/File;)Z
...
.method public static getNextFilePath(Landroid/app/Activity;Ljava/lang/String;Lcom/android/camera/DCFRuler$fileFormat;Lcom/android/camera/DCFInfo;)Lcom/android/camera/DCFRuler$PathPackage;
    ...
    :cond_b
    new-instance p0, Lcom/android/camera/DCFRuler$PathPackage;

    invoke-direct {p0}, Lcom/android/camera/DCFRuler$PathPackage;-><init>()V

    iput v4, p0, Lcom/android/camera/DCFRuler$PathPackage;->mImageCounter:I

    iput v3, p0, Lcom/android/camera/DCFRuler$PathPackage;->mDirectoryCounter:I
    ...
    iput-object p1, p0, Lcom/android/camera/DCFRuler$PathPackage;->mFileName:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/camera/DCFRuler$PathPackage;->mDirectoryName:Ljava/lang/String;
...
.method public static getVideoNameAndNumber(Landroid/app/Activity;Ljava/lang/StringBuffer;)I
    ...
    invoke-static {p0, v2, v0, v1, v3}, Lcom/android/camera/DCFRuler;->ensureDirectoryExists(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)I
    ...
    invoke-static {v3, v1}, Lcom/android/camera/FileUtility;->isFileExistent(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v1, v4}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    new-instance v0, Lcom/android/camera/DCFRuler$3;

    invoke-direct {v0, v4}, Lcom/android/camera/DCFRuler$3;-><init>(I)V

    invoke-static {v3, v0, v1}, Lcom/android/camera/FileUtility;->enumerateFiles(Ljava/lang/String;Lcom/android/camera/FileUtility$FileEnumerationCallback;Ljava/lang/Object;)Z
