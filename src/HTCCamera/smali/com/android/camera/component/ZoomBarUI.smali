...
.method private registerListeners()V
    ...
    const-string v1, "Zoom.Increased"
    ...
    const-string v1, "Zoom.Decreased"

    new-instance v2, Lcom/android/camera/component/ZoomBarUI$13;

    invoke-direct {v2, p0}, Lcom/android/camera/component/ZoomBarUI$13;-><init>(Lcom/android/camera/component/ZoomBarUI;)V
...
.method private updateZoomBarLayout(I)V
    ...
    invoke-virtual {v4, v7}, Lcom/android/camera/rotate/RotateRelativeLayout;->setOrientation(I)V

    :cond_0
    iget-object v4, p0, Lcom/android/camera/component/ZoomBarUI;->m_ZoomBackground:Lcom/android/camera/rotate/RotateRelativeLayout;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/camera/component/ZoomBarUI;->m_ZoomIn:Landroid/widget/RelativeLayout;
    ...
    :cond_2
    iget-object v4, p0, Lcom/android/camera/component/ZoomBarUI;->m_ZoomOut:Landroid/widget/RelativeLayout;
...
.method public canShowZoom()Z
    ...
    iget-boolean v0, p0, Lcom/android/camera/component/ZoomBarUI;->m_menuIsOpen:Z
    ...
    iget-boolean v0, p0, Lcom/android/camera/component/ZoomBarUI;->m_UIOpen:Z

    if-nez v0, :cond_2

    :cond_1
    invoke-virtual {p0, v1}, Lcom/android/camera/component/ZoomBarUI;->hideZoomBar(Z)V
...
.method public isInteractiveEffect()Z
    ...
    iget-object v2, p0, Lcom/android/camera/component/ZoomBarUI;->mHTCCamera:Lcom/android/camera/HTCCamera;
    ...
    invoke-virtual {v2}, Lcom/android/camera/HTCCamera;->getGpuEffectContr()Lcom/android/camera/GpuEffectController;

    move-result-object v1

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Lcom/android/camera/GpuEffectController;->getCurrEffect()Ljava/lang/String;
